...
export default function DashboardScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={[styles.card, styles.purpleCard]} onPress={() => router.push('/exhaust')}>
        ...
        <Ionicons name="arrow-forward" size={24} color="white" style={styles.cardIcon} />
      </TouchableOpacity>
      ...
      <LinearGradient
        ...
        style={styles.gradientCard}
      >
        <TouchableOpacity style={styles.card} onPress={() => router.push('/heartrate')}>
      ...
      <LinearGradient
        ...
        style={styles.gradientCard}
      >
        <TouchableOpacity style={styles.card} onPress={() => router.push('/p2p')}>
